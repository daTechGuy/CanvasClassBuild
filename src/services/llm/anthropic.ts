...
import { getClient, getThinkingTokens, MODELS } from '../claude/client';
import type { StreamCallbacks, StreamOptions, WebSearchResult } from './types';
...
export async function sendMessageAnthropic(
